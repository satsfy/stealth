...
[`stealth-core`](../core/README.md).

It implements `stealth_core::gateway::BlockchainGateway` and is used by both:
...
The output is converted into `stealth-core` gateway types (`WalletHistory`,
...
# let _ = gateway;
# Ok::<(), stealth_core::error::AnalysisError>(())
```
